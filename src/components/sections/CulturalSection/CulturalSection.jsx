...
import img1 from './fotosession.jpg';
            ...
            <div className='container mx-auto'>
                ...
                >
                    ...
                    <div className="grid grid-cols-3 grid-rows-2 gap-4 mx-auto">
                        ...
                        <motion.div
                            className="relative overflow-hidden row-span-2 rounded-xl group cursor-pointer"
                            custom={2}
                            initial="hidden"
                            whileInView="visible"
                            variants={imageVariants}
                ...
                <div className="space-y-6">
                    ...
                    <div className="prose prose-lg max-w-none">
                        <p className="text-gray-600">
                            {t("CulturalSection.modalContent1")}
                        </p>

                        <h4 className="text-xl font-semibold mt-6">
                            {t("CulturalSection.modalSubtitle")}
                        </h4>

                        <ul className="list-disc pl-6 space-y-2 mt-3">
                            <li>{t("CulturalSection.modalFeature1")}</li>
                            <li>{t("CulturalSection.modalFeature2")}</li>
                            <li>{t("CulturalSection.modalFeature3")}</li>
                            <li>{t("CulturalSection.modalFeature4")}</li>
                        </ul>

                        <p className="text-gray-600 mt-6">
                            {t("CulturalSection.modalContent2")}
                        </p>
                    </div>
