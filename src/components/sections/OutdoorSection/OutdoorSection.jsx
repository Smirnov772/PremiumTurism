...
import img2 from './Rectangle 10.jpeg';
                ...
                <div className="space-y-6">
                    ...
                    <div className="prose prose-lg max-w-none">
                        <p className="text-gray-600">
                            {t("OutdoorSection.modalContent1")}
                        </p>

                        <h4 className="text-xl font-semibold mt-6">
                            {t("OutdoorSection.modalSubtitle")}
                        </h4>

                        <ul className="list-disc pl-6 space-y-2 mt-3">
                            <li>{t("OutdoorSection.modalFeature1")}</li>
                            <li>{t("OutdoorSection.modalFeature2")}</li>
                            <li>{t("OutdoorSection.modalFeature3")}</li>
                            <li>{t("OutdoorSection.modalFeature4")}</li>
                        </ul>

                        <p className="text-gray-600 mt-6">
                            {t("OutdoorSection.modalContent2")}
                        </p>
                    </div>
